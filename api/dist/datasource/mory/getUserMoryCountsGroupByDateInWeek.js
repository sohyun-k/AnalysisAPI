...
var postProcessOfMoryDateCount = function (rows, year, weekNumber) {
    ...
    var result = [];
    for (var i = 0; i < 7; i++) {
        var d = (0, moment_1["default"])().isoWeek(weekNumber).year(year).day(i).format("YYYY-MM-DD").toString();
...
//# sourceMappingURL=getUserMoryCountsGroupByDateInWeek.js.map